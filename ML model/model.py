...
def getResult(currImage):
    ...
    return("Results:glioma- {:.2f} percent confident based on {} images, meningioma- {:.2f} percent confident based on {} images, no tumor- {:.2f} percent confident based on {} images,pituitary- {:.2f} percent confident based on {} images. \n"
